...
Proxy.re_encrypt_capsule = function(capsule, rk){
    // capsule.E * rk.rk
    var capsule_copy = capsule;
    var prime_E = capsule_copy.get_E().mul(rk.get_re_key()); 
    // capsule.V * rk.rk
    var prime_V = capsule_copy.get_V().mul(rk.get_re_key()); 
    var prime_S = capsule_copy.get_S();
